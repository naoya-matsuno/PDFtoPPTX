...
class Window():
    ...
    def __init__(self) -> None:
        ...
        self.__convert_btn = tkinter.Button(self.__window, text="Convert", command=self.__pushConvert, justify=tkinter.CENTER,  state=tkinter.DISABLED)
    ...
    def __pushConvert(self) -> None:
        ...
        if writable:
            ...
            slides.convertPPTX(self.__process_label)
